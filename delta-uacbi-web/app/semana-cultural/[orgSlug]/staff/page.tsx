      ...
      <main className="container py-10">
        ...
        <section className="card-next mx-auto max-w-3xl rounded-3xl p-6 sm:p-8">
          ...
          <p className="mt-3 text-sm leading-7 text-muted-foreground">
            Este acceso es solo para personal staff o administradores de {organization.name}. Primero
            inicia sesion con tu cuenta institucional y despues pide que un administrador te agregue
            como miembro de la organizacion.
          </p>

          <div className="mt-6">
            <LoginButton
              callbackUrl={`/semana-cultural/${orgSlug}/admin/dashboard`}
          ...
          {session?.user ? (
            <div className="mt-6 rounded-2xl border border-amber-300/20 bg-amber-300/10 p-4">
              <p className="text-sm text-amber-50">
                Tu cuenta ya inicio sesion, pero aun no tiene un rol asignado en esta organizacion.
              </p>
            </div>
          ) : null}
        </section>
