  ...
  return (
    <>
      ...
      <main className="container py-10">
        <h1 className="text-3xl font-semibold tracking-tight">Usuarios de la plataforma</h1>
        <p className="mt-2 text-muted-foreground">
          Rol global: gobierna acceso a modulos de toda la plataforma (ej. Delta Tickets). El acceso
          a una organizacion especifica de Semana Cultural se administra desde &quot;Miembros&quot; dentro de
          cada organizacion.
        </p>
